    ...
    <view class="content">
      ...
      <view class="info">
        <view class="integral_section" @tap="integrals">
          <view class="top">
            ...
            <text class="value">{{ isLogin ? userInfo.pointNum : "***" }}</text>
          </view>
          <view class="bottom">
            进入积分商城兑换奈雪券及周边好礼
      ...
      <view class="member-news">
        <view class="header">
          ...
          <view class="iconfont iconRightbutton" @tap="news"></view>
        </view>
        <view class="list">
          <view class="item">
            <image
              src="https://img-shop.qmimg.cn/s23107/2020/04/27/0039bf41c9ebd50a2c.jpg"
            ></image>
