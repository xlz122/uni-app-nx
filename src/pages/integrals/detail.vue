    ...
    <view style="padding-bottom: 150rpx">
        ...
        <view class="bg-white mb-30">
          ...
          <view class="d-flex flex-column" style="padding: 30rpx">
            <view class="d-flex align-items-center mb-10">
              ...
              <view
                v-if="pointGood.amount > 0"
                class="font-size-sm text-color-base"
      ...
      <template v-else>
        <view class="coupon-box">
          <view class="coupon">
            <image
              src="/static/images/integrals/ticket.png"
              mode="center"
            ></image>
            <view class="intro">
        ...
        <view class="points-and-stocks">
          <view class="points">
            <view
              class="font-size-lg text-color-primary font-weight-bold mr-10"
              >{{ pointGood.points_price }}</view
            >
